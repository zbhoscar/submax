...
a,b,c,d=collect_features('/absolute/datasets/Anomaly-Detection-Dataset/Temporal_Anomaly_Annotation_for_Testing_Videos.txt', '/absolute/datasets/anoma_motion_original_test_only_c3d_npy', '/absolute/datasets/anoma_motion_pyramid_120_85_c3d_npy', '/absolute/datasets/anoma_spatial_annotations',max_num=64)
