...
tags.DEFINE_string('npy_file_path',
                   '/absolute/datasets/anoma_motion_pyramid_180_127_all_json',
...
tags.DEFINE_integer('batch_size', 20, 'batch size.')
...
tags.DEFINE_float('regularization_scale', 0.0006, 'regularization scale')
