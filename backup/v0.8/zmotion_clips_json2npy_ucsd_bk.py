...
JSON_FILE_LIST, DATASET_PATH, REDUCE_METHOD, REDUCE_NUM = (
    ('/absolute/datasets/UCSDped2_reform_motion_pyramid_60_42_all_json',
     '/absolute/datasets/UCSDped2_reform', 'simple', 120),
    ('/absolute/datasets/UCSDped2_reform_motion_original_all_json',
     '/absolute/datasets/UCSDped2_reform', 'simple', 120),
    'TYPE')[0]
...
def get_merge_list(json_path_list):
    output = []
