...
class OrigFramesTFR(object):
    def __init__(self, data_root='/abs', inputdata='sf_UCF101frames', epoch_num=200, is_training=True, batch_size=64):
        self.tfrecords_dpath = osp.join(data_root, inputdata)
        self.source_dpath = osp.join(data_root, oz_flags.StrAna(inputdata).source_folder())
    ...
    def check_and_create_tfrecords(self, tfrecords_list, class_list):
        """
