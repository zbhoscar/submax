...
def run_test():
    ...
    eval_result_folder = basepy.check_or_create_path(
        base_io.DATASET_PATH + '_%d%d_c3d_clips_features' % (base_io.CLIP_LENGTH, base_io.SEGMENT_NUMBER),
            ...
            while True:
                ...
                with tf.device('/cpu:0'):
                    ...
                    for i in range(len(c)):
                        ...
                        _ = basepy.write_txt_add_lines(feature_txt_path, str(l2e[i].tolist()), str(d[i]), str(c[i]))
